...
function loadBonzis(a) {
    loadQueue.loadManifest([
       { id: "bonziAqua", src: "./img/bonzi/aqua.png" },
        ...
        { id: "bonziPuro", src: "./img/bonzi/puro.png" },
                    ...
                    build: function (a, b) {
                        return {
                            items: {
                                ...
                                fun: {
                                    name: "Gamer Mod CMDS",
                                    visible: function () { return (typeof window !== 'undefined' && window.admin) || (typeof king !== "undefined" && king); },
                                    items: {
                                        bless: {
                                            name: "Bless",
                                            callback: function () {
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow","quartz", "nethergold","purplesaber","krosh","miracle-machine","pope","blessed","cameraman","cartoonnetwork","brasilempire","stella","grinnyboi","yan","peedy" ,"bustystickwoman", "femboykisser", "ruby","navy", "chartreuse", "sapphire","lavenderribbon" ,"clock","puro"], b = 0; b < a.length; b++) {
                        var c = a[b],
