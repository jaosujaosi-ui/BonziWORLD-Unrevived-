                    ...
                    build: function (a, b) {
                        return {
                            items: {
                                ...
                                fun: {
                                    name: "Gamer Mod CMDS",
                                    visible: function () { return admin || (typeof king !== "undefined" && king); },
                                    items: {
                                        bless: {
                                            name: "Bless",
                                            callback: function () {
        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = [ "black", "blue", "brown", "green","pink", "purple", "red",  "pope", "blessed"], b = 0; b < a.length; b++) {
                        var c = a[b],
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = [ "bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen",  "bonziPink", "bonziPurple", "bonziRed", "bonziPink", "topjej"];
